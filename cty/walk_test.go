...
func TestWalk(t *testing.T) {
	...
	val := ObjectVal(map[string]Value{
		...
		"union":         UnionVal(Union(map[string]Type{"foo": String, "bar": Bool}), "foo", StringVal("bar")),
	...
	wantCalls := []Call{
		...
		{`cty.Path{cty.GetAttrStep{Name:"union"}}`, "union"},
		{`cty.Path{cty.GetAttrStep{Name:"union"}, cty.GetAttrStep{Name:"bar"}}`, "bool"},
		{`cty.Path{cty.GetAttrStep{Name:"union"}, cty.GetAttrStep{Name:"foo"}}`, "string"},
...
func TestTransformWithTransformer(t *testing.T) {
	val := ObjectVal(map[string]Value{
		...
		"object":        ObjectVal(map[string]Value{"true": True}),
		"object_empty":  EmptyObjectVal,
		"union":         UnionVal(Union(map[string]Type{"a": String}), "a", StringVal("blorp")),
		"null":          NullVal(String),
	...
	wantVal := ObjectVal(map[string]Value{
		...
		"object_empty":  EmptyObjectVal,
		"union":         UnionVal(Union(map[string]Type{"a": String}), "a", StringVal(`cty.Path{cty.GetAttrStep{Name:"union"}, cty.GetAttrStep{Name:"a"}}`)),
