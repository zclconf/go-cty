...
// CidrHostFunc is a function that calculates a full host IP address
...
// CidrNetmaskFunc is a function that converts an IPv4 address prefix given
...
// CidrSubnetFunc is a function that calculates a subnet address within
